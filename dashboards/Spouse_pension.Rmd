...
We will be considering a spouse model, the insured will get a yearly pension $P$, in case of death of one of the isured dies. Let insured number one have age $x$ and age of insured number two have age $y$.
...
#both survive:
p_00 <- function(t, n){
    p_surv(x, G="M", Y=2022, t=t,s = n)*p_surv(y, G="F", Y=2022, t=0, s=n)
  }
